package com.mvcseries.interceptors;
...
public class DayOfWeekBasedAccessInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		// If this method returns true then - Application will further handle the
		// request
		// If this method returns false then - Application will not further handle the
		// request
